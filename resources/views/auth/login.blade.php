<x-guest-layout>
    ...
    <div class="w-full max-w-md p-12 space-y-8 bg-[#212C30] backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-700/50">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            {{-- Tombol Masuk --}}
            <div>
                 <button type="submit" class="w-full text-center bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-3 px-4 rounded-lg transition-colors duration-300 mt-4">
                    Masuk
                </button>
            </div>
        </form>
