<header class="w-full flex items-center p-6 bg-gray-900 border-b border-gray-700 sticky top-0 z-10">
    <div class="flex items-center space-x-4 flex-1 min-w-0">
        ...
        <div class="relative hidden lg:block flex-1 min-w-0">
            ...
            <input type="text" placeholder="Cari barang hilang" class="w-full bg-gray-800 border border-gray-700 rounded-full py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-yellow-500">
        </div>
    </div>
