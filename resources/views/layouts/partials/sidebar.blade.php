<aside class="w-64 bg-gray-900 p-6 border-r border-gray-700 h-screen sticky top-0">
    ...
    <nav class="space-y-4">
        {{-- Menu Beranda --}}
        {{-- Logika baru: Terapkan 'bg-gray-700' HANYA JIKA rute saat ini adalah 'dashboard' --}}
        ...
        {{-- Menu Katalog --}}
        {{-- TODO: Ganti '#' dengan route yang benar dan tambahkan logika state aktif seperti menu lainnya --}}
        ...
        {{-- Menu Lapor --}}
        {{-- Logika baru: Terapkan 'bg-gray-700' HANYA JIKA rute saat ini adalah 'complaint.create' --}}
